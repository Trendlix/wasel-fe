...
const contactInfoTitleClass = "font-medium text-[22.74px] leading-[34.11px] tracking-0 text-main-dutchOrigin";
const contactIconClass = "w-[30.32px] h-[30.32px] text-main-dutchOrigin shrink-0";
...
const formLabelIconClass = "w-4 h-4 text-main-dutchOrigin shrink-0";
const inputClass = "w-full rounded-lg bg-main-lightBlack px-4 py-3 text-white placeholder:text-main-dmGray placeholder:font-normal placeholder:text-sm placeholder:leading-[100%] placeholder:tracking-0 border-0 outline-none focus:ring-1 focus:ring-main-dutchOrigin";
...
const ContactItem = ({ item }: { item: IContactItem }) => {
    ...
    return (
        <div className="flex items-start gap-x-4">
            ...
            <div>
                <p className={clsx(contactItemClass, "text-main-dutchOrigin")}>{label}</p>
                {item.id === "email" ? (
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            <div className="w-full lg:w-1/2 xl:w-[40%] xl:flex-none min-w-0">
                <p className={contactInfoTitleClass}>
                    {t("contactInfoTitle")}
                </p>
            ...
            <div className="w-full lg:w-1/2 xl:w-[60%] xl:flex-1 min-w-0 rounded-lg p-6 md:p-8 bg-main-sportBlack">
                <h2 className="font-medium text-[20.21px] leading-[30.32px] tracking-0 text-white">
                    {t("sendMessageTitle")}
                </h2>
                <form className="mt-[30px] flex flex-col gap-10">
                    ...
                    <button
                        type="submit"
                        className="w-full rounded-full bg-main-dutchOrigin py-4 font-medium text-[20.21px] leading-[30.32px] tracking-0 text-black hover:opacity-90 transition-opacity"
                    >
                        {t("sendButton")}
                    </button>
                </form>

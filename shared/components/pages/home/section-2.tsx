...
type Section2Props = {
    ...
    transportContent?: NonNullable<IHomePageResponse["content"]>["transport"] | null;
};
...
const Section2 = ({ heroLayoutReady = false, transportContent = null }: Section2Props) => {
                ...
                <div className="flex gap-4 max-md:flex-col">
                    <div className="lg:w-[60%] md:w-[50%] space-y-4 mt-20 flex flex-col items-end">
                        <Card1
                            ...
                            dir={dir}
                            title={transportContent?.card_1?.title}
                            description={transportContent?.card_1?.description}
                        />
                        <Card3
                            ref={(el) => { cardsRefs.current[2] = el; }}
                            dir={dir}
                            title={transportContent?.card_3?.title}
                            description={transportContent?.card_3?.description}
                        />
                    </div>
                    <div className="lg:w-[40%] md:w-[50%]">
                        <Card2
                            ...
                            dir={dir}
                            title={transportContent?.card_2?.title}
                            description={transportContent?.card_2?.description}
                        />
                    </div>
                </div>
            </div>
